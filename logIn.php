  ...
  <body id="pageTop">
    ...
    <div class="fixed-top">
      <div style="background-color: white;">
        ...
        <a href="logIn.php" class="float-right text-dark">
        <?php        
    ...
    <div style="text-align: center">      
      ...
      <a href='create.php' class='btn btn-info'>CREATE ACCOUNT</a>      
    </div>
    ...
    if($_SERVER['REQUEST_METHOD']==='POST'){
      ...
      $result = mysqli_query($connection, $sql) or die("Wrong email or wrong password!".mysqli_error($connection));
